...
var _cv_detail = __webpack_require__(68);

var _cv_detail2 = _interopRequireDefault(_cv_detail);

var _cv_list = __webpack_require__(69);

var _cv_list2 = _interopRequireDefault(_cv_list);

var _registerServiceWorker = __webpack_require__(71);
...
var App = function App() {
    return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_cv_list2.default, null),
        _react2.default.createElement(_cv_detail2.default, null)
    );
};
...
var CVDetail = function (_Component) {
    _inherits(CVDetail, _Component);

    function CVDetail() {
        _classCallCheck(this, CVDetail);

        return _possibleConstructorReturn(this, (CVDetail.__proto__ || Object.getPrototypeOf(CVDetail)).apply(this, arguments));
    }

    _createClass(CVDetail, [{
        key: 'render',
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(CVDetail);
...
var CVList = function (_Component) {
    _inherits(CVList, _Component);

    function CVList() {
        _classCallCheck(this, CVList);

        return _possibleConstructorReturn(this, (CVList.__proto__ || Object.getPrototypeOf(CVList)).apply(this, arguments));
    }
    ...
    _createClass(CVList, [{
        ...
        value: function renderList() {
            ...
            return this.props.CVs.map(function (cv) {
                return _react2.default.createElement(
                    'li',
                    { key: cv.id, onClick: function onClick() {
                            return _this2.props.selectCV(cv);
                        } },
                    cv.name
                );
            });
...
function mapDispatchToProps(dispatch) {
    return (0, _redux.bindActionCreators)({
        selectCV: _index.selectCV
    }, dispatch);
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(CVList);
...
var _reducer_cvs = __webpack_require__(73);

var _reducer_cvs2 = _interopRequireDefault(_reducer_cvs);

var _reducer_active_cv = __webpack_require__(74);

var _reducer_active_cv2 = _interopRequireDefault(_reducer_active_cv);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var rootReducer = (0, _redux.combineReducers)({
    CVs: _reducer_cvs2.default,
    selectedCV: _reducer_active_cv2.default
});
