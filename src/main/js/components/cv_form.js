...
class CVForm extends Component{
    ...
    onSubmit(values) {
        if (this.props.match.params.id){
            this.props.updateCV(values, this.props.match.params.id, (cv) => {
...
CVForm = connect(mapStateToProps, { createCV, updateCV, selectCV, deselectCV })(CVForm);
